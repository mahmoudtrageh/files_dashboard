...
@section('title', 'تعديل المشرف: ' . $admin->name)

@section('content')
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-gray-900">تعديل المشرف: {{ $admin->name }}</h1>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="bg-white">
                        <div class="px-4 py-5 sm:px-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">يرجى ملء جميع الحقول المطلوبة. اترك حقل كلمة المرور فارغًا للاحتفاظ بنفس كلمة المرور.</p>
                        </div>
